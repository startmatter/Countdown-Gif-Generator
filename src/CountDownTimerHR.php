...
class CountDownTimerHR implements ClockInterface {
    ...
    public function __construct($dateTime, $timezone = 'America/Los_Angeles', $backgroundImageFile = 'cuntDownWhiteBGHR.png', $fontFile = 'Lato-Bold.ttf') {
